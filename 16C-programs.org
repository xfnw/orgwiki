...
press ~g P/R~ to toggle programming mode, ~SST~ and ~g BST~ to move
around, ~GTO . <nnn>~ to jump to a line, ~BSP~ to delete a line, and
~g RTN~ to end a program.
