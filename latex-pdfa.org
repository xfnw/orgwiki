#+TITLE: creating accessible PDF/A files with LaTeX
...
* tagged pdf
there is currently not a good solution for generating accessible
(tagged) pdfs with LaTeX. the ~accessibility~ package is pretty much
